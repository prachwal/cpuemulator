...
/// <summary>
/// Instrukcja Add - dodaje wartości dwóch rejestrów.
/// </summary>
public class AddInstruction : IInstruction
{
    /// <inheritdoc />
    /// <summary>
    /// Wykonuje instrukcję Add - dodaje wartości dwóch rejestrów i ustawia flagi.
    /// </summary>
    ...
    public CpuState Execute(CpuState state, Instruction instruction)
    {
        ...
        var newFlags = newState.Flags
            ...
            .WithCarryFlag((ulong)(uint)value1 + (ulong)(uint)value2 > uint.MaxValue)
